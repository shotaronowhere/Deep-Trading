...
- `ActionSetKind` / `ActionSetSpec`: ordered, typed action-set definitions (`Buy`, `Sell`, `Mint`, `Merge`) used to build mixed-step previews without ad-hoc per-branch vector wiring.
